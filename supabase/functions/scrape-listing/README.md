...
This Supabase Edge Function securely scrapes property listing details using the Firecrawl API without exposing the API key to the client.
...
1. The scraped property data directly, or
